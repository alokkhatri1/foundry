...
//
// Each prompt has four pieces, all required at submit time:
...
//   - note:    free-text reflection — what clicked or didn't.
//   - habit:   implementation-intention prompt — when / what / who.
//              This is the "habit-forming" piece: a concrete real-world
//              action the participant commits to so the learning lands.
...
export const REFLECTION_PROMPTS = {
  '3': {
    ...
    habit: 'Pick one document from your work this week. When will you try giving it to the AI as context?',
  },
  '4': {
    ...
    habit: 'Pick one repeating task at work. When will you draft a skill file for it?',
  },
  '5': {
    label: 'AI Coworkers',
    ...
    habit: 'Pick one role on your team an AI coworker could augment. When will you build it?',
  },
  '6': {
    label: 'Orchestration',
    ...
    habit: 'Sketch one real workflow you’ll try at work. When will you wire it up?',
  },
  '7': {
    label: 'Observability',
    ...
    habit: 'Next time you run a workflow, what one specific thing will you check in the run log?',
  },
  '8': {
    label: 'Capstone',
    ...
    habit: 'What’s your first concrete action to bring this workflow to your team this week?',
  },
  '9': {
    label: 'Copilot',
    ...
    habit: 'This week, what real workflow will you build with the copilot, and when?',
  },
  '10': {
    label: 'Economics',
    ...
    habit: 'Set a monthly AI budget for your team. What’s the ceiling, and how will you track spend against it?',
  },
};
